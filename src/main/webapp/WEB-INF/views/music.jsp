	...
	<div class="row mb-2">
       <div class="col-12">
            ...
            <select class="form-select" name="orderBy"  onchange="this.form.submit()">
                <option value="bid" selected>정렬 기준 선택</option>
	...
	<div class="row">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
            <div class="card" >
                ...
                <div class="card-body">
                    <h5 class="card-title">[Music]${dto.bTitle}</h5><a href="select_one?bId=${dto.bId}" class="stretched-link select_one" data-bs-toggle="modal" data-bs-target="#exampleModal"></a>
...
*/
	$(document).ready(function(){
		var current1 = document.getElementById("menu_music1");
		var current2 = document.getElementById("menu_music2");
		current1.classList.add('active');
		current2.classList.add('active');
